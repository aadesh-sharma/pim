 ...
 */
final class Version20210121060842 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD post_thumbnail VARCHAR(255) DEFAULT NULL, CHANGE status status ENUM(\'draft\', \'reviewed\', \'published\')');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP post_thumbnail, CHANGE status status VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
